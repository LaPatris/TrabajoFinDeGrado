...
public class Avatar2 
{
	...
	public static HumanDescription CreateHumanDescription(GameObject avatarRoot, Dictionary<string, string> names)
	{
		HumanDescription description = new HumanDescription()
		{
			...
			human = CreateHuman(avatarRoot, names),
		};
		return description;
	}
	...
	private static HumanBone[] CreateHuman(GameObject avatarRoot, Dictionary<string, string> names)
	{
		...
		foreach (Transform avatarTransform in avatarTransforms)
		{
			if (names.TryGetValue(avatarTransform.name, out string humanName))
			{
